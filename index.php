...
<html lang="en">
  	...
  	<body>
  		<div class="container-fluid">
            ...
            if (empty($_GET["page"])) { ?>
                <nav class="navbar navbar-expand-lg navbar-light bg-warning fixed-top">
                    <a class="navbar-brand" href="#">SELAMAT DATANG | <b>PUSKESMAS </b></a>
        ...
        // jika halaman = staf, maka tampilkan halaman halaman tampil_data
        elseif ($_GET['page']=='data_staf') {
            include "tampil_data.php";
        }
        elseif ($_GET['page']=='data_dokter') {
            include "dokter/tampil_data.php";
        }
