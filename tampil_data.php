    ...
    $(document).ready(function() {
        ...
        var table = $('#tabel-pegawai').DataTable( {
            ...
            "columnDefs": [ 
                ...
                { "targets": 10, "width": '80px', "className": 'center' },
                {
                  "targets": 11, "data": null, "orderable": false, "searchable": false, "width": '80px', "className": 'center',
                  "render": function(data, type, row) {
                      var btn = "<a style=\"margin-right:7px\" title=\"Ubah\" class=\"btn btn-outline-info btn-sm\" href=\"?page=ubah&no_reg="+data[ 2 ]+"\"><i class=\"fas fa-edit\"></i></a><span><a title=\"Hapus\" class=\"btn btn-outline-danger btn-sm\" href=\"proses_hapus.php?no_reg="+data[ 2 ]+"\"><i class=\"fas fa-trash\"></i></a></span>";
                      return btn;
                  } 
                } 
            ],
