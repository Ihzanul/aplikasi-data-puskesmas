...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
            <thead style="background:#e8ecee">
                <tr class="tr-title">
                    ...
                    <th height="30" align="center" valign="middle">Tanggal Regis</th>
                    <th height="30" align="center" valign="middle">Nomor Regis</th>
                    ...
                    <th height="30" align="center" valign="middle">Keluhan</th>
                    <th height="30" align="center" valign="middle">Alamat</th>
                    <th height="30" align="center" valign="middle">No. Hp</th>
                    <th height="30" align="center" valign="middle">Terapy</th>
                </tr>
            </thead>
            <tbody>
            <?php  
            ...
            $result = $mysqli->query("SELECT * FROM pegawai ORDER BY nama_pasien ASC")
            ...
            if ($rows > 0) {
                while ($data = $result->fetch_assoc()) { ?>
                    <tr>
                        ...
                        <td width="150" height="25" align="center" valign="middle"><?php echo date('d-m-Y', strtotime($data['tanggal_regis'])); ?></td>
                        <td width="150" height="25" align="center" valign="middle"><?php echo $data['no_reg']; ?></td>
                        <td style="padding-left:5px;" width="180" height="25" valign="middle"><?php echo $data["nama_pasien"]; ?></td>
                        ...
                        <td width="120" height="25" align="center" valign="middle"><?php echo $data["keluhan"]; ?></td>
                        ...
                        <td width="100" height="25" align="center" valign="middle"><?php echo $data["Terapy"]; ?></td>
                    </tr>
                 <?php
                    $no++;
                } 
        ...
        <div id="footer-tanggal">
            Bunta, <?php echo tgl_eng_to_ind(date("d-m-Y")); ?>
        </div>
        <div id="footer-titik">
            ..........................................................
        </div>
